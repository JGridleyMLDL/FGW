...
class Fused_Gromov_Wasserstein_distance():
    ...
    def __init__(self, alpha=0.5, method='shortest_path', features_metric='sqeuclidean', max_iter=500, verbose=False, amijo=True):
        self.method = method
    ...
    def get_key_info(self, graph1, graph2):
        nodes1 = graph1.nodes()
        nodes2 = graph2.nodes()
        ...
        return M, C1, C2, t1masses, t2masses
